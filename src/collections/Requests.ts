...
export const requests: { [key in keyof typeof EResourceType]: (args: IFetchArgs | IPostArgs) => AxiosRequestConfig } = {
	...
	MEDIA_UPLOAD_APPEND: (args: IPostArgs) => MediaRequests.appendUpload(args.upload!.id!, args.upload!.media! as ArrayBuffer),
	...
	USER_BOOKMARKS: (args: IFetchArgs) => UserRequests.bookmarks(args.id!, args.count, args.cursor),
